from dnd_bot.logic.domain.creature import Creature
...
class Player(Creature):
    ...
    def __init__(self, entity_id: int, x: int, y: int, sprite, name: str, skill, hp: int, strength: int, dexterity: int,
        ...
        super.__init__(entity_id, x, y, sprite, name, skill, hp, strength, dexterity, intelligence, charisma, perception,
                       initiative, action_points, level)
